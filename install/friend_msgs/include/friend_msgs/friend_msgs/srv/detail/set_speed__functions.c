...
friend_msgs__srv__SetSpeed_Request__create()
{
  ...
  friend_msgs__srv__SetSpeed_Request * msg = (friend_msgs__srv__SetSpeed_Request *)allocator.allocate(sizeof(friend_msgs__srv__SetSpeed_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(friend_msgs__srv__SetSpeed_Request));
  bool success = friend_msgs__srv__SetSpeed_Request__init(msg);
  if (!success) {
...
friend_msgs__srv__SetSpeed_Request__destroy(friend_msgs__srv__SetSpeed_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    friend_msgs__srv__SetSpeed_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
friend_msgs__srv__SetSpeed_Request__Sequence__init(friend_msgs__srv__SetSpeed_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  friend_msgs__srv__SetSpeed_Request * data = NULL;

  if (size) {
    data = (friend_msgs__srv__SetSpeed_Request *)allocator.zero_allocate(size, sizeof(friend_msgs__srv__SetSpeed_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = friend_msgs__srv__SetSpeed_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        friend_msgs__srv__SetSpeed_Request__fini(&data[i - 1]);
      }
...
friend_msgs__srv__SetSpeed_Request__Sequence__fini(friend_msgs__srv__SetSpeed_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      friend_msgs__srv__SetSpeed_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  friend_msgs__srv__SetSpeed_Request__Sequence * array = (friend_msgs__srv__SetSpeed_Request__Sequence *)allocator.allocate(sizeof(friend_msgs__srv__SetSpeed_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = friend_msgs__srv__SetSpeed_Request__Sequence__init(array, size);
  if (!success) {
...
friend_msgs__srv__SetSpeed_Request__Sequence__destroy(friend_msgs__srv__SetSpeed_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    friend_msgs__srv__SetSpeed_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
friend_msgs__srv__SetSpeed_Request__Sequence__are_equal(const friend_msgs__srv__SetSpeed_Request__Sequence * lhs, const friend_msgs__srv__SetSpeed_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!friend_msgs__srv__SetSpeed_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  friend_msgs__srv__SetSpeed_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(friend_msgs__srv__SetSpeed_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    friend_msgs__srv__SetSpeed_Request * data =
      (friend_msgs__srv__SetSpeed_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!friend_msgs__srv__SetSpeed_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          friend_msgs__srv__SetSpeed_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!friend_msgs__srv__SetSpeed_Request__copy(
...
friend_msgs__srv__SetSpeed_Response__are_equal(const friend_msgs__srv__SetSpeed_Response * lhs, const friend_msgs__srv__SetSpeed_Response * rhs)
{
  ...
  // previous_speed
  if (lhs->previous_speed != rhs->previous_speed) {
    return false;
  }
  // new_speed
  if (lhs->new_speed != rhs->new_speed) {
    return false;
  }
  // stalled
  ...
  friend_msgs__srv__SetSpeed_Response * output)
{
  ...
  // previous_speed
  output->previous_speed = input->previous_speed;
  // new_speed
  output->new_speed = input->new_speed;
  // stalled
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  friend_msgs__srv__SetSpeed_Response * msg = (friend_msgs__srv__SetSpeed_Response *)allocator.allocate(sizeof(friend_msgs__srv__SetSpeed_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(friend_msgs__srv__SetSpeed_Response));
  bool success = friend_msgs__srv__SetSpeed_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
friend_msgs__srv__SetSpeed_Response__destroy(friend_msgs__srv__SetSpeed_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    friend_msgs__srv__SetSpeed_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
friend_msgs__srv__SetSpeed_Response__Sequence__init(friend_msgs__srv__SetSpeed_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  friend_msgs__srv__SetSpeed_Response * data = NULL;

  if (size) {
    data = (friend_msgs__srv__SetSpeed_Response *)allocator.zero_allocate(size, sizeof(friend_msgs__srv__SetSpeed_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = friend_msgs__srv__SetSpeed_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        friend_msgs__srv__SetSpeed_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
friend_msgs__srv__SetSpeed_Response__Sequence__fini(friend_msgs__srv__SetSpeed_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      friend_msgs__srv__SetSpeed_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  friend_msgs__srv__SetSpeed_Response__Sequence * array = (friend_msgs__srv__SetSpeed_Response__Sequence *)allocator.allocate(sizeof(friend_msgs__srv__SetSpeed_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = friend_msgs__srv__SetSpeed_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
friend_msgs__srv__SetSpeed_Response__Sequence__destroy(friend_msgs__srv__SetSpeed_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    friend_msgs__srv__SetSpeed_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
friend_msgs__srv__SetSpeed_Response__Sequence__are_equal(const friend_msgs__srv__SetSpeed_Response__Sequence * lhs, const friend_msgs__srv__SetSpeed_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!friend_msgs__srv__SetSpeed_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  friend_msgs__srv__SetSpeed_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(friend_msgs__srv__SetSpeed_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    friend_msgs__srv__SetSpeed_Response * data =
      (friend_msgs__srv__SetSpeed_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!friend_msgs__srv__SetSpeed_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          friend_msgs__srv__SetSpeed_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!friend_msgs__srv__SetSpeed_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
