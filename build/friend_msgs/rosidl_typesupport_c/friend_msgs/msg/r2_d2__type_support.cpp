...
static const _R2D2_type_support_symbol_names_t _R2D2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, friend_msgs, msg, R2D2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, friend_msgs, msg, R2D2)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, friend_msgs, msg, R2D2)() {
  return &::friend_msgs::msg::rosidl_typesupport_c::R2D2_message_type_support_handle;
}
