...
{
  new (message_memory) friend_msgs::srv::SetSpeed_Request(_init);
}

void SetSpeed_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<friend_msgs::srv::SetSpeed_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetSpeed_Request_message_member_array[1] = {
  {
    ...
    offsetof(friend_msgs::srv::SetSpeed_Request, desired_speed),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetSpeed_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(friend_msgs::srv::SetSpeed_Request),
...
{
  return &::friend_msgs::srv::rosidl_typesupport_introspection_cpp::SetSpeed_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, friend_msgs, srv, SetSpeed_Request)() {
  return &::friend_msgs::srv::rosidl_typesupport_introspection_cpp::SetSpeed_Request_message_type_support_handle;
}
...
void SetSpeed_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) friend_msgs::srv::SetSpeed_Response(_init);
}

void SetSpeed_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<friend_msgs::srv::SetSpeed_Response *>(message_memory);
  typed_message->~SetSpeed_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SetSpeed_Response_message_member_array[3] = {
  {
    "previous_speed",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(friend_msgs::srv::SetSpeed_Response, previous_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(friend_msgs::srv::SetSpeed_Response, new_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(friend_msgs::srv::SetSpeed_Response, stalled),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetSpeed_Response_message_members = {
  ...
  3,  // number of fields
  sizeof(friend_msgs::srv::SetSpeed_Response),
...
{
  return &::friend_msgs::srv::rosidl_typesupport_introspection_cpp::SetSpeed_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, friend_msgs, srv, SetSpeed_Response)() {
  return &::friend_msgs::srv::rosidl_typesupport_introspection_cpp::SetSpeed_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetSpeed_service_members = {
  ...
  // see get_service_type_support_handle<friend_msgs::srv::SetSpeed>()
...
get_service_type_support_handle<friend_msgs::srv::SetSpeed>()
{
  ...
  auto service_type_support =
    &::friend_msgs::srv::rosidl_typesupport_introspection_cpp::SetSpeed_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, friend_msgs, srv, SetSpeed)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<friend_msgs::srv::SetSpeed>();
}
