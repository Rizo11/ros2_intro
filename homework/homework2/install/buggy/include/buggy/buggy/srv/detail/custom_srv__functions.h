...
#ifndef BUGGY__SRV__DETAIL__CUSTOM_SRV__FUNCTIONS_H_
#define BUGGY__SRV__DETAIL__CUSTOM_SRV__FUNCTIONS_H_
...
#include "buggy/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_buggy
bool
 ...
 * calls
 * buggy__srv__CustomSrv_Request__init().
...
/**
 * It calls
 * buggy__srv__CustomSrv_Request__fini()
 ...
 * buggy__srv__CustomSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * buggy__srv__CustomSrv_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * buggy__srv__CustomSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_buggy
...
/**
 * It calls
 * buggy__srv__CustomSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_buggy
...
/**
 * It allocates the memory for the array and calls
 * buggy__srv__CustomSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_buggy
...
/**
 * It calls
 * buggy__srv__CustomSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BUGGY__SRV__DETAIL__CUSTOM_SRV__FUNCTIONS_H_
