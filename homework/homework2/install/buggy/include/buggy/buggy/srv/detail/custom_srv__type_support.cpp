...
{
  new (message_memory) buggy::srv::CustomSrv_Request(_init);
}

void CustomSrv_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<buggy::srv::CustomSrv_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomSrv_Request_message_member_array[1] = {
  {
    ...
    offsetof(buggy::srv::CustomSrv_Request, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomSrv_Request_message_members = {
  "buggy::srv",  // message namespace
  "CustomSrv_Request",  // message name
  1,  // number of fields
  sizeof(buggy::srv::CustomSrv_Request),
...
{
  return &::buggy::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buggy, srv, CustomSrv_Request)() {
  return &::buggy::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Request_message_type_support_handle;
}
...
void CustomSrv_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) buggy::srv::CustomSrv_Response(_init);
}

void CustomSrv_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<buggy::srv::CustomSrv_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomSrv_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(buggy::srv::CustomSrv_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomSrv_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(buggy::srv::CustomSrv_Response),
...
{
  return &::buggy::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buggy, srv, CustomSrv_Response)() {
  return &::buggy::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers CustomSrv_service_members = {
  "buggy::srv",  // service namespace
  "CustomSrv",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<buggy::srv::CustomSrv>()
...
get_service_type_support_handle<buggy::srv::CustomSrv>()
{
  ...
  auto service_type_support =
    &::buggy::srv::rosidl_typesupport_introspection_cpp::CustomSrv_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buggy, srv, CustomSrv)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<buggy::srv::CustomSrv>();
}
