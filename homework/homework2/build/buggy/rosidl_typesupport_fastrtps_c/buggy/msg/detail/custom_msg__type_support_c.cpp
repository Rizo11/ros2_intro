...
#include "buggy/msg/detail/custom_msg__rosidl_typesupport_fastrtps_c.h"
...
using _CustomMsg__ros_msg_type = buggy__msg__CustomMsg;
...
static uint32_t _CustomMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_buggy__msg__CustomMsg(
...
static size_t _CustomMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_buggy__msg__CustomMsg(
